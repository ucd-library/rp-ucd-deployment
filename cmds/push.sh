...
docker push $HARVEST_IMAGE_NAME:$HARVEST_TAG
docker tag $HARVEST_IMAGE_NAME:$HARVEST_TAG $HARVEST_IMAGE_NAME:$DOCKER_CACHE_TAG
...
docker push $MODEL_IMAGE_NAME:$VESSEL_TAG
docker tag $MODEL_IMAGE_NAME:$VESSEL_TAG $MODEL_IMAGE_NAME:$DOCKER_CACHE_TAG

docker push $API_IMAGE_NAME:$VESSEL_TAG
docker tag $API_IMAGE_NAME:$VESSEL_TAG $API_IMAGE_NAME:$DOCKER_CACHE_TAG

docker push $AUTH_IMAGE_NAME:$VESSEL_TAG
docker tag $AUTH_IMAGE_NAME:$VESSEL_TAG $AUTH_IMAGE_NAME:$DOCKER_CACHE_TAG
